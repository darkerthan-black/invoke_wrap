...
fn main() {
    ...
    // invoke_wrap!(CommConnect, self.comp_kiwoom, 0x1, DISPATCH_METHOD, VT_I4, 0 );
    invoke_wrap!(GetLoginInfo,self.comp_kiwoom,0x4, DISPATCH_METHOD,VT_BSTR, 1,  arg_str, VT_BSTR   );
    // invoke_wrap!(CommRqData, self.comp_kiwoom, 0x3, DISPATCH_METHOD, VT_I4, 4,
    //                 sRQName,
    //                sTrCode,
    //                nPrevNext,
    //                sScreenNo )
